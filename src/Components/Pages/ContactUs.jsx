...
//   /* 🔥 FORCE IDENTICAL UI ON WINDOWS + MACOS */
//   appearance: none;
//   -webkit-appearance: none;
//   -moz-appearance: none;

//   /* 🔥 Custom dropdown arrow (same on every OS) */
...
/* FULLY NORMALIZED INPUT — identical on macOS & Windows */
const Input = styled.input`
  width: 100%;
  height: 48px;
  padding: 0 1rem;
...
/* FULLY NORMALIZED SELECT — identical everywhere */
const Select = styled.select`
  width: 100%;
  height: 48px;
  padding: 0 1rem;
  ...
  return (
    <Wrapper>
      ...
      <Right onSubmit={handleSubmit}>
        ...
        <InputWrapper>
          <Label active={!!formData.opportunity}>Tell us about your opportunity*</Label>
          <TextArea
            name="opportunity"
            value={formData.opportunity}
            onChange={handleChange}
